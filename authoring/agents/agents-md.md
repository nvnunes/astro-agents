...
- Use the file to activate applicable shared prompt assets or deeper repo docs, not to duplicate them.
- Do not let one `AGENTS.md` file drift into doing the job of `README.md`, architecture docs, testing docs, or a neighboring prompt asset.
