...
## Role
- Treat `README.md` as a special repo doc: the main human-facing starting document into the repo or folder it describes.
...
- A top-level repo `README.md` has the strongest starting document obligation: identify the repo, explain its value, and point readers to the main deeper docs.
