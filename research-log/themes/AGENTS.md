...
Use this file first for routine maintenance of theme-document research-log hierarchies inside the `research-log/` shared prompt family.
...
- `Capture`: read `research-log/themes/instructions/operation-capture.md`.
- `Update`: read `research-log/themes/instructions/operation-summary-update.md`.
- `Check`: read `research-log/themes/instructions/operation-summary-check.md`.

The operation file owns the behavioral frame and routes to file guides when more detail is needed.

## Task Routing

- Creating a new theme-document hierarchy: read `research-log/themes/instructions/operation-create-theme.md`.
- Upgrading an existing source document into a theme hierarchy: read `research-log/themes/instructions/operation-upgrade-source-document.md`.
- Creating or revising `<theme>.md`: read `research-log/themes/instructions/file-summary.md`.
- Creating or revising `<theme>/index.md`: read `research-log/themes/instructions/file-index.md`.
- Adding, revising, reorganizing, or associating concepts: read `research-log/themes/instructions/operation-manage-concepts.md`.
- Creating or revising dated entry files: read `research-log/themes/instructions/file-entry.md`.
- Creating or revising entry-local `data/manifest.md`: read `research-log/themes/instructions/file-data-manifest.md`.
- Capturing images, data, generated outputs, manifests, or scripts: use `research-log/themes/instructions/operation-capture.md`.
