...
It is the current concrete pattern inside the `research-log/` shared prompt family, not a project-specific research log.

For routine maintenance, use `research-log/themes/AGENTS.md`. This document remains the fuller concept and design reference.
...
The reusable theme-document guidance is organized as a small routed prompt surface.

- `research-log/themes/AGENTS.md`: routing entrypoint. It identifies the needed operation, applies global safety rules, and points to narrower instruction files.
- `research-log/themes/instructions/file-*.md`: file-writing guides. These explain how to create or revise specific research-log document types.
- `research-log/themes/instructions/operation-*.md`: operation guides. These explain how to perform work such as capture, summary updates, summary checks, source-document upgrades, or concept management.

Expansion should preserve this taxonomy unless there is a clear reason not to.

- Put concept, rationale, and taxonomy in `research-log/themes/README.md`.
- Put routing, operation selection, and global safety gates in `research-log/themes/AGENTS.md`.
- Put reusable operational detail in `research-log/themes/instructions/`.
