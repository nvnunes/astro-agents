...
- use these shared built-in workflow starting files:
  - `skills/code-quality-review/references/python/code-quality-review.md`

## Review Checks

- if the requested scope is clearly Python, run `skills/code-quality-review/references/python/code-quality-review.md`
