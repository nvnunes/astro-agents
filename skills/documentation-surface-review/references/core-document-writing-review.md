...
- use the applicable writing skill or shared writing reference when reviewing human-facing docs
- default to `skills/readme-writing/references/readme-md.md` for `README.md` and folder-level `README.md` files
- default to `skills/project-docs-writing/references/project-docs.md` for glossary/reference docs and other project-facing or public-facing operational docs
- inspect the target project's `docs/glossary.md`, when present, only when the target docs rely on recurring project terms whose meaning or ownership materially affects writing clarity
...
- human-facing docs vs the applicable writing skill or shared writing reference
...
- agent-surface structure review beyond what is needed to judge document writing
- `AGENTS.md` review
- prompt, skill, or skill-reference writing review under `skills/` or project-local agent surfaces
