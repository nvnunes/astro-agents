...
Treat this file as the main internal workflow reference for `skills/documentation-surface-review/SKILL.md`.
...
- use these shared built-in workflow starting files:
  - `skills/documentation-surface-review/references/private-default/documentation-review.md`
  - `skills/documentation-surface-review/references/public-python/documentation-review.md`

## Review Checks

- if the chosen documentation surface profile is `private-default`, run `skills/documentation-surface-review/references/private-default/documentation-review.md`
- if the chosen documentation surface profile is `public-python`, run `skills/documentation-surface-review/references/public-python/documentation-review.md`
...
- agent-surface structure review beyond what the chosen documentation review workflow needs
- application-code review
- direct selection of `skills/documentation-surface-review/references/core-document-writing-review.md` for generic docs requests
...
- name `skills/documentation-surface-review/SKILL.md`
