...
- use `skills/documentation-surface-review/references/core-document-writing-review.md` as the shared writing-review file after choosing that surface
...
Apply all review criteria from `skills/documentation-surface-review/references/core-document-writing-review.md` to the selected `private-default` documentation surface.
...
- name the applicable writing skill or shared writing reference
