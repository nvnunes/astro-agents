...
This reference is the public Python documentation surface model used by
...
- do not hardcode absolute paths to a private workspace shared library
- use a generic bootstrap line such as `Use astro-agents as a shared library
  for reusable skills, review, and upgrade planning.`
- when the project adapts examples from `astro-agents`, mention them explicitly
  rather than assuming they will be rediscovered indirectly

This allows a user to keep a reusable shared library without baking
