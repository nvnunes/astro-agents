...
define published project documentation. Inherit the common writing discipline
from `skills/technical-writing/references/base.md`, then apply the additional rules below.
