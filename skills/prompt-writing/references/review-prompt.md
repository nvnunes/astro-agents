...
## Purpose
Use this style for prompts that review prompts, `AGENTS.md` files, and related documentation or instruction systems. Inherit the common prompt-writing discipline from `skills/prompt-writing/references/prompt-base.md`, then apply the additional rules below.
