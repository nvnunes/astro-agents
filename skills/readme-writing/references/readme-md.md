...
## Purpose
Use this style for `README.md` files. Inherit the common writing discipline from `skills/technical-writing/references/base.md` and the shared project-documentation discipline from `skills/project-docs-writing/references/project-docs.md`, then apply the `README.md`-specific rules below.
...
- Keep workflow rules, instruction authority, and deeper operational detail in `AGENTS.md`, architecture docs, testing docs, validation docs, or plans rather than explaining them fully here.
