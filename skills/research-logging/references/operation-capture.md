...
- Add or suggest an `AI Use:` note when AI materially affected what was retained, relied on, or decided; use `skills/research-logging/references/file-entry.md` for the note format.
...
- When a targeted summary update is obvious, use `skills/research-logging/references/operation-summary-update.md` after capture and report the summary change succinctly.
...
2. If no existing concept fits, use `skills/research-logging/references/operation-manage-concepts.md` when the user intent already implies a new concept; otherwise ask before adding a top-level concept.
...
7. Preserve the captured material in the new entry using `skills/research-logging/references/file-entry.md`.
...
Use `skills/research-logging/references/file-data-manifest.md` when an entry depends on external, large, canonical, or move-prone data assets.
...
- For dated entry structure and command format, read `skills/research-logging/references/file-entry.md`.
- For timeline cards and entry IDs, read `skills/research-logging/references/file-index.md`.
- For entry-local `data/manifest.md`, read `skills/research-logging/references/file-data-manifest.md` only when external data or manifest-backed commands are needed.
