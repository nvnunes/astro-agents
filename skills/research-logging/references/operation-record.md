...
document evidence and observations; continue an investigation; reorganize the
log; or otherwise preserve or revise research-log material.
...
should be logged, or adding, revising, or reorganizing log material.
...
A Review finding may recommend Reorganize but does not authorize it. Do not
turn Continue into Reorganize because an entry is long, contains distinct
topics, or has an imperfect folder slug.
