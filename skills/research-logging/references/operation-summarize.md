# Summarize Operation Instructions

Use this file when the user asks to update `<log>.md`, when one or more entries clearly change current understanding, or when structural changes require summary links to be updated.

`Summarize` updates the maintained summary. It should synthesize entries rather than restating them chronologically.

Read `skills/research-logging/references/file-summary.md` for summary-writing guidance.
