...
When editing summary prose, apply `skills/research-logging/references/file-summary.md`, including its `skills/project-docs-writing/references/project-docs.md` style boundary. Keep updates direct and compressed; do not expand `<theme>.md` to preserve every detail from the entry.
...
- For index routing or affected concepts, read `skills/research-logging/references/file-index.md`.
