...
EVIDENCE_V2 = importlib.import_module("validation.evidence_v2")
...
class EvidenceV2FileTests(unittest.TestCase):
    def test_active_dispatch_is_v2_only(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaisesRegex(
                EVIDENCE_V2.EvidenceV2Error, "evidence.upgrade_required"
            ):
