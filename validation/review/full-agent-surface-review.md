...
## Purpose
Use this prompt to review the project's agent surface as one combined validation target. Use it when the user wants a combined validation pass across prompt-writing quality, routing and scope behavior, and the applicable profile-scoped documentation review workflow.
...
- determine applicable project-local review files under `agents/validation/`
...
- broad project critique outside the prompt and instruction system
...
- name the included project-local review files when any were included
...
- keep the review focused on prompt and instruction-system changes rather than general project critique
